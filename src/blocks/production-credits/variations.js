...
const variations = [
  {
    ...
    description: __('Display the production team: directors, designers, choreographers, and crew.', 'theatrum-credits'),
    icon: 'groups',
  ...
  },
  {
    ...
    description: __('Display the cast members (actors).', 'theatrum-credits'),
    icon: 'admin-users',
  ...
  },
  {
    ...
    description: __('Display producers and partner credits.', 'theatrum-credits'),
    icon: 'businessman',
