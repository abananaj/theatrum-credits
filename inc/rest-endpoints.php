...
define(
    'THEATRUM_CREDITS_VALID_ROLE_GROUPS',
    array(
...
define(
    'THEATRUM_CREDITS_PRODUCER_META_MAP',
    array(
...
add_action(
    ...
    register_rest_route(
        'theatrum/v1',
        '/production-credits/(?P<post_id>\d+)',
        array(
        array(
        'methods'             => 'GET',
...
add_action(
    ...
    register_rest_route(
        'theatrum/v1',
        '/production-credits/(?P<post_id>\d+)/reorder',
        array(
        'methods'             => 'POST',
